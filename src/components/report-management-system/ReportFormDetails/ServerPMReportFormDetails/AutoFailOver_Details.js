  ...
  return (
    <Box sx={{ 
      ...
      <Box sx={{ 
        ...
        >
          Auto Fail Over Check
        </Typography>
      </Box>
      {/* Instructions */}
      <Typography variant="body1" sx={{ marginBottom: 2, fontStyle: 'italic' }}>
        Check the auto failover functionality of the SCADA server to ensure redundancy is working properly.
      </Typography>
        ...
        <Grid item xs={12}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, marginBottom: 1 }}>
            <Typography variant="body1" sx={{ fontWeight: 'bold' }}>
              Result: Auto failover of SCADA server is functioning properly.
            </Typography>
            {result && (
              <Chip
