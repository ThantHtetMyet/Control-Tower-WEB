...
const CMReviewReportFormEdit = () => {
  ...
  const [notification, setNotification] = useState({
    open: false,
    message: '',
    severity: 'success' // 'success', 'error', or 'warning'
  });
      ...
      <Box sx={{
        ...
        >
          <Alert
            ...
            sx={{
              width: '100%',
              backgroundColor: notification.severity === 'success' ? '#d4edda' : 
                              notification.severity === 'warning' ? '#fff3cd' : '#f8d7da',
              color: notification.severity === 'success' ? '#155724' : 
                     notification.severity === 'warning' ? '#856404' : '#721c24',
              '& .MuiAlert-icon': {
                color: notification.severity === 'success' ? '#28a745' : 
                       notification.severity === 'warning' ? '#ffc107' : '#dc3545'
              }
            }}
          >
