...
const OccupationLevelEdit = () => {
  ...
  useEffect(() => {
    fetchOccupationLevel();
  }, [id]);

  const fetchOccupationLevel = async () => {
    try {
      ...
      showNotification('Error fetching occupation level: ' + err.message, 'error');
    } finally {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData || 'Failed to update occupation level');
      }
            ...
            <Box component="form" onSubmit={handleSubmit}>
              <Stack spacing={3}>
                ...
                <TextField
                  ...
                  rows={3}
                  variant="outlined"
                  helperText="Describe the occupation level requirements and characteristics"
                  sx={{
                    '& .MuiOutlinedInput-root': {
                      '&:hover fieldset': {
                        borderColor: '#34C759',
                ...
                <TextField
                  ...
                  required
                  error={!!errors.rank}
                  helperText={errors.rank || "Enter the rank/priority of this level (1 = highest)"}
                  variant="outlined"
                  inputProps={{ min: 1 }}
                  sx={{
                    '& .MuiOutlinedInput-root': {
                ...
                <Stack direction="row" spacing={2} justifyContent="flex-end" sx={{ mt: 4 }}>
                  ...
                  >
                    {loading ? 'Updating...' : 'Update Occupation Level'}
                  </Button>
                </Stack>
              </Stack>
            </Box>
...
export default OccupationLevelEdit;